...
/// classic.
void tcreateimgplaceholder(uint32_t image_id, uint32_t placement_id, int cols, int rows, char do_not_move_cursor, Glyph *text_underneath) {
